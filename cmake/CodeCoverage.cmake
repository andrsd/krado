...
if(KRADO_CODE_COVERAGE)
    ...
    if(CMAKE_C_COMPILER_ID MATCHES "(Apple)?[Cc]lang" OR CMAKE_CXX_COMPILER_ID MATCHES "(Apple)?[Cc]lang")
        ...
        set(CODE_COVERAGE_PROFRAWS
            ${CMAKE_BINARY_DIR}/test/krado-test.profraw
        )
        ...
        set(CODE_COVERAGE_BINS
            --object=${PROJECT_BINARY_DIR}/test/krado-test
            --object=${PROJECT_BINARY_DIR}/lib/libkrado${CMAKE_SHARED_LIBRARY_SUFFIX}
        )
