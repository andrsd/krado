...
PYBIND11_MODULE(krado, m)
{
    ...
    py::class_<GeomSurface>(m, "GeomSurface")
        ...
        .def("embedded_vertices", &GeomSurface::embedded_vertices)
        .def("embedded_curves", &GeomSurface::embedded_curves)
    ;
    ...
    py::class_<MeshElement>(m, "MeshElement")
        ...
        .def("barycenter", &MeshElement::barycenter)
        .def("volume", &MeshElement::volume)
    ...
    py::class_<MeshCurve, MeshingParameters>(m, "MeshCurve")
        ...
        .def("add_vertex", py::overload_cast<MeshVertex *>(&MeshCurve::add_vertex))
        .def("add_vertex", py::overload_cast<MeshCurveVertex *>(&MeshCurve::add_vertex))
    ...
    py::class_<MeshSurface, MeshingParameters>(m, "MeshSurface")
        ...
        .def("embedded_vertices", &MeshSurface::embedded_vertices)
        .def("embedded_curves", &MeshSurface::embedded_curves)
        .def("add_vertex", py::overload_cast<MeshVertex *>(&MeshSurface::add_vertex))
        .def("add_vertex", py::overload_cast<MeshCurveVertex *>(&MeshSurface::add_vertex))
        .def("add_vertex", py::overload_cast<MeshSurfaceVertex *>(&MeshSurface::add_vertex))
        ...
        .def("mesh_size_from_boundary", &MeshSurface::mesh_size_from_boundary)
