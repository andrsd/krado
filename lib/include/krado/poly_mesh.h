...
///
bool intersect(PolyMesh::Vertex * v0,
               PolyMesh::Vertex * v1,
               PolyMesh::Vertex * b0,
               PolyMesh::Vertex * b1);

PolyMesh::Face * walk(PolyMesh::Face * f, UVParam uv);

Optional<u64> recover_edge(PolyMesh & pm, PolyMesh::Vertex * v_start, PolyMesh::Vertex * v_end);

PolyMesh::HalfEdge * color(PolyMesh::HalfEdge * he, int color);
