...
void
Shape::remove_degenerated_edges()
{
    TopExp_Explorer exp;
...
void
Shape::remove_small_edges(double tolerance)
{
    TopExp_Explorer exp;
    ShapeBuild_ReShape rebuild;
    for (exp.Init(this->shape, TopAbs_EDGE); exp.More(); exp.Next()) {
...
void
Shape::fix_small_edges(double tolerance)
{
...
void
Shape::fix_small_wires(double tolerance)
{
...
void
Shape::fix_small_faces(double tolerance)
{
...
void
Shape::sew_faces(double tolerance)
{
...
void
Shape::make_solids(double tolerance)
{
    TopExp_Explorer exp;
