...
MeshModel::MeshModel(const GeomModel & model) :
...
MeshModel::vertices() const
{
    return this->vtxs;
}

const MeshCurve &
MeshModel::curve(int id) const
{
    try {
...
MeshModel::curves() const
{
    return this->crvs;
}

const MeshSurface &
MeshModel::surface(int id) const
{
    try {
...
MeshModel::surfaces() const
{
    return this->surfs;
}

const MeshVolume &
MeshModel::volume(int id) const
{
    try {
...
MeshModel::volumes() const
{
    return this->vols;
}

void
MeshModel::initialize(const GeomModel & model)
{
...
void
MeshModel::mesh_vertex(MeshVertex & vertex)
{
    if (!vertex.is_meshed()) {
        vertex.set_meshed();
    }
...
void
MeshModel::mesh_curve(MeshCurve & curve)
{
    if (!curve.is_meshed()) {
...
void
MeshModel::mesh_surface(MeshSurface & surface)
{
...
void
MeshModel::mesh_volume(MeshVolume & volume)
{
    if (!volume.is_meshed()) {
...
void
MeshModel::assign_gid(MeshVertex & vertex)
{
...
void
MeshModel::assign_gid(MeshCurveVertex & vertex)
{
    this->pnts.emplace_back(vertex.point());
    vertex.set_global_id(this->gid_ctr);
    this->gid_ctr++;
...
void
MeshModel::assign_gid(MeshSurfaceVertex & vertex)
{
    this->pnts.emplace_back(vertex.point());
    vertex.set_global_id(this->gid_ctr);
    this->gid_ctr++;
...
void
MeshModel::add_mesh_point(Point & mpnt)
{
    this->pnts.emplace_back(mpnt);
}

void
MeshModel::number_points()
{
    this->exp_bbox.reset();
...
BoundingBox3D
MeshModel::bounding_box() const
{
    return this->exp_bbox;
}

BoundingBox3D
MeshModel::compute_bounding_box() const
{
    BoundingBox3D bbox;
