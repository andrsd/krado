...
private:
    ...
    void
    add_edge(i64 edge_idx, const std::array<i64, 2> & edge, i64 curve_id, bool req)
    {
        bamg::R2 zero2(0, 0);
    ...
    bamg::Geometry Gh;
    bamg::Real8 Hmin;
    std::map<Ptr<MeshVertexAbstract>, i64> local_vtx_id;
    bamg::Real4 * len;
    bamg::Triangles * Th;
    bamg::Int4 * reft;
    bamg::Int4 nbInT;
