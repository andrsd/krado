...
namespace bamg {
  ...
  class P2 {
   ...
   public:
    ...
    //  RR   operator*(const P2<R,RR> & cc) const {return  (RR) x* (RR) cc.x+(RR) y* (RR) cc.y;} //
    //  produit scalaire
  ...
  class P2xP2 {    // x ligne 1 y ligne2
   ...
   public:
    ...
    P2xP2< R, RR > operator*(P2xP2< R, RR > c) const {
      return P2xP2< R, RR >(x.x * c.x.x + x.y * c.y.x, x.x * c.x.y + x.y * c.y.y,
                            y.x * c.x.x + y.y * c.y.x, y.x * c.x.y + y.y * c.y.y);
    }
